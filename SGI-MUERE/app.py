...
def obtener_conexion():
    try:
        ...
        print(f"❌ Error de conexión a Clever Cloud: {e}")
        return None
...
if 'conexion_db' not in st.session_state:
    st.session_state.conexion_db = None
            ...
            if correo and contrasena:
                with st.spinner("Verificando credenciales..."):
                    if modo == "🔐 Modo Real":
                        ...
                        if conexion:
                            st.session_state.conexion_db = conexion
